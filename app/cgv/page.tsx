...
export default async function Cgv() {
  ...
  return (
    <main id="main">
      <PageHero
        title={en ? "Terms & Conditions of Sale" : "Conditions Générales de Vente"}
        lead={en ? "Version in force since May 22, 2026." : "Version en vigueur depuis le 22 mai 2026."}
        crumb={en ? "T&Cs" : "CGV"}
      />
            ...
            <>
              ...
              <div className="page-toc">
                ...
                <ol>
                  ...
                  <li><a href="#art2">Pricing</a></li>
                  <li><a href="#art3">Order</a></li>
                  <li><a href="#art4">Payment</a></li>
                  <li><a href="#art5">Delivery</a></li>
                  <li><a href="#art6">Satisfaction-or-refund guarantee</a></li>
                  <li><a href="#art7">Right of withdrawal</a></li>
                  <li><a href="#art8">Liability</a></li>
                  <li><a href="#art9">Intellectual property</a></li>
                  <li><a href="#art10">Personal data</a></li>
                  <li><a href="#art11">Force majeure</a></li>
                  <li><a href="#art12">Applicable law &amp; disputes</a></li>
                </ol>
              </div>
              ...
              <p>Failing an amicable resolution, the consumer Client may use, free of charge, the following consumer mediator: <span className="placeholder">[TO COMPLETE — name and contact details of the mediator, e.g. FEVAD e-commerce mediator]</span>.</p>
            ...
            <>
              ...
              <div className="page-toc">
                ...
                <ol>
                  ...
                  <li><a href="#art2">Tarifs</a></li>
                  <li><a href="#art3">Commande</a></li>
                  <li><a href="#art4">Paiement</a></li>
                  <li><a href="#art5">Livraison</a></li>
                  <li><a href="#art6">Garantie satisfait ou remboursé</a></li>
                  <li><a href="#art7">Droit de rétractation</a></li>
                  <li><a href="#art8">Responsabilité</a></li>
                  <li><a href="#art9">Propriété intellectuelle</a></li>
                  <li><a href="#art10">Données personnelles</a></li>
                  <li><a href="#art11">Force majeure</a></li>
                  <li><a href="#art12">Loi applicable &amp; litiges</a></li>
                </ol>
              </div>
              ...
              <p>À défaut de résolution amiable, le Client consommateur peut recourir gratuitement au médiateur de la consommation suivant : <span className="placeholder">[À COMPLÉTER — nom et coordonnées du médiateur, ex. Médiateur du e-commerce de la FEVAD]</span>.</p>
